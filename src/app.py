...
activities = {
    ...
    "Track and Field": {
        "description": "Train for sprints, distance runs, and field events",
    ...
    "Drama Workshop": {
        "description": "Learn acting techniques and rehearse short scenes",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
        "participants": ["amelia@mergington.edu", "henry@mergington.edu"]
    },
    "Math Circle": {
        "description": "Solve challenging math problems and learn new concepts",
